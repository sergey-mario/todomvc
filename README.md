...
Описание: После очистки локальных данных браузера и перезагрузки страницы пользователь остается на одной из последних выбранных вкладок меню (All, Active или Complete).

**Шаги к воспроизведению:**
1.	Открыть главную страницу сайта (http://todomvc.com/examples/vanillajs/).
2.	Создать новую задачу (запись «Ice cream»).
3.	Завершить созданную задачу.
4.	Перейти в меню Complete.
5.	Очистить локальные данные браузера (Devtools – Application –Clear Storage – Clear site data).
6.	Перезагрузить страницу.
7.	Создать новую задачу.

**Ожидаемый результат:**
введенная задача отображается на странице. Пользователь находится в меню All

**Фактический результат:**
введенная запись не отображается на странице. Пользователь находится в меню Completed
